...
p = df %>% 
  ggplot(aes(x = x, y = y)) +
  geom_point(pch = 15, size = 0.5, stroke = 1) # pch = 5, size = 2
if (method == "circular") {
...
p + scale_x_reverse(breaks = seq(from = nstitches, to = 1, by = -1)) +
