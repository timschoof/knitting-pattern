...
You can personalize this pattern based on your knitting speed using [this Shiny app](https://github.com/timschoof/knitting-shiny). You can also specify whether you want to knit the pattern in the round, using circular needles, or as a regular scarf, stitching the ends together at the end. Lastly, you can choose whether you want the bobbles regularly spaced, or whether you want to add a bit of jitter to the data
