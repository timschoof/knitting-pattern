...
While the pattern shown here assumes a knitting speed of 20 stitches per minute, you may be a faster or slower knitter. If that's the case, you can personalize the pattern based on your own knitting speed using [this Shiny app](https://github.com/timschoof/knitting-shiny). Personalizing the pattern based on your knitting speed will give you a knitting experience that will more closely match the rate of maternal deaths reflected in the pattern. The Shiny app also allows you to specify whether you want the bobbles regularly spaced, or whether you want to add a bit of jitter to the data.
